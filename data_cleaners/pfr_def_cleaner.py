...
class PFRDefCleaner:
    ...
    def calculate_def_vs_te(self, def_vs_te):
        ...
        def_vs_te["team_abbev"] = def_vs_te["team"].map(TEAM_NAME_TO_ABBR)
    ...
    def calculate_def_vs_qb(self, def_vs_qb):
        ...
        def_vs_qb["def_total_tds_allowed"] = def_vs_qb["rush_tds"] + def_vs_qb["rec_tds"] / def_vs_qb["games"]
        ...
        def_vs_qb["def_fantpy_allowed"] = def_vs_qb["fantpt_per_game"]
        def_vs_qb["def_rush_ypa_allowed"] = def_vs_qb["rush_yds"] / def_vs_qb["rush_att"]
        def_vs_qb["team_abbev"] = def_vs_qb["team"].map(TEAM_NAME_TO_ABBR)
    ...
    def calculate_def_vs_wr(self, def_vs_wr):
        ...
        def_vs_wr["team_abbev"] = def_vs_wr["team"].map(TEAM_NAME_TO_ABBR)
